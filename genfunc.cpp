...
// Database::Database() {
//     // Initialize:
//     if (typeid(*this) == typeid(Database)) {  // Replace with your derived classes
//         num_columns = 6;
//         database_filename = "openings.txt";
//     } else {
//         cout << "not a valid database" << endl;
//         exit(1);
//     }
//     general_database = new string*[num_columns];
//     ifstream infile;
